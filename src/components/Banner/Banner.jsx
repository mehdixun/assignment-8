...
const Banner = () => {
 ...
 App Store</button></a>
            ...
            <div className='bg-gradient-to-b from-indigo-600 to-indigo-400 lg:h-[300px] p-10 mb-10'>
            ...
            <div className='flex flex-col lg:flex-row justify-evenly items-center my-8 text-white'>
                <div className=''>
                    <p className='text-white opacity-70 text-center'>Total Downloads</p>
                    <h2 className='mb-2 font-bold text-[64px]'>29.6M</h2>
                    <p className='text-white opacity-70 text-center'>21% more than last month</p>
                </div>
                <div>
                    <p className='text-white opacity-70 text-center'>Total Reviews</p>
                    <h2 className='mb-2 font-bold text-[64px]'>906K</h2>
                    <p className='text-white opacity-70 text-center'>46% more than last month</p>
                </div>
                <div>
                    <p className='text-white opacity-70 text-center'>Active Apps</p>
                    <h2 className='mb-2 font-bold text-[64px]'>132+</h2>
                    <p className='text-white opacity-70 text-center'>31 more will Launch</p>
                </div>
            </div>
            </div>
        </div>
